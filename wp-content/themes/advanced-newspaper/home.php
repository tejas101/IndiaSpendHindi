...
<div id="primarycontent">
	...
	<script id="mNCC" language="javascript">  medianet_width='300';  medianet_height= '250';  medianet_crid='621660518';  </script>  
		<script id="mNSC" src="http://contextual.media.net/nmedianet.js?cid=8CU5Z545Q" language="javascript"></script> 
            ...
            <a  href="http://www.indiaspendhindi.com/category/मोदी-का-संदेश-राज्यों-की-प">
			<p id="read"> इस श्रृंखला के अन्य लेख</p> </a>
...
<div id="secondarycontent">
	...
	<div id="secondary-right">
		...
		<div class="most_section">
			<div class="tab">
			<a class="active_most" href="javascript:void(0)" id="most_read" onclick="popularpost(this.id)" >अधिकतम पढ़े</a>
			<a href="javascript:void(0)" id="most_popular" onclick="" ></a>
			<a href="javascript:void(0)" id="most_mail" onclick="" ></a>
			</div>
...
<a class="twitter-timeline" href="https://twitter.com/indiaspendhindi" data-widget-id="586413317792497664">Tweets by @indiaspendhindi</a>
