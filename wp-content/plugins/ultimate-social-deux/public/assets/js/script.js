...
jQuery(document).ready(function() {
		...
		jQuery('.us_total').each(function() {
			var template = '<div class="us_box"><div class="us_count" style="margin-top: -11px;font-size: 18px;margin-left: 13px;">{total}</div><div class="us_share" style="margin-left: -38px;font-size: 10px;">' + us_script.total_shares_text + '</div></div>';
